<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.master" AutoEventWireup="true" CodeFile="Eggless.aspx.cs" Inherits="Eggless" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 style="background-color:#fd6d6d" class="auto-style1">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:label runat="server" text="Eggless" ForeColor="Black" Font-Bold="True" Font-Size="XX-Large"></asp:label>
    </h1>
            ...
            <table class="auto-style2" border="1">
                ...
                <tr>
                    <td class="auto-style3">&nbsp;<asp:Label ID="Label4" runat="server" Text="Quantity:-"></asp:Label>
                        ...
                        <asp:Label ID="Label5" runat="server" Text="in Kgs"></asp:Label></td>
                </tr>
                <tr>
                    <td class="auto-style3">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="select * from tbl_Product where pr_FoodType='Eggless' order by  pr_id  desc"></asp:SqlDataSource>
</asp:Content>
