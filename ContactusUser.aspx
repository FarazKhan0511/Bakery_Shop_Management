<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.master" AutoEventWireup="true" CodeFile="ContactusUser.aspx.cs" Inherits="ContactusUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Large" ForeColor="#0033CC" Text="vishalsingh@gmail.com"></asp:Label>
            </td>
        </tr>
         <tr>
            <td class="auto-style4">
